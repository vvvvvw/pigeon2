...
public enum RequestQualityManager {
    ...
    //requestUrl：context.getInvokerConfig().getUrl() + "#" + context.getMethodName()
    ...
    /**
     * 根据方法的服务质量过滤，优先保留服务质量good的clients，数量低于least时加入所有服务质量normal的clients
     * @param clientList
     * @param request
     * @param least 最少保留个数
     * @return
     */
    //从所有client中挑选出服务url与request请求的服务相同且服务质量为good的client
